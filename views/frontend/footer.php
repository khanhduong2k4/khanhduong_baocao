<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 KhanhDuongShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
               ...
               <p class="pt-1">
                  Điện thoại: 0967 419 133(call, zalo) - Email: khanhduong21102004@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Nguyễn Hồ Khánh Dương - Phone: 0967419133
      </div>
   </section>
</body>
